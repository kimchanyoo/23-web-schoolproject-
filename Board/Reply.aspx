...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="all-content" >
        <div class="text">
            <img class="text-img" src="../images/img-add.png" />&nbsp;&nbsp;&nbsp;답 변 쓰 기
        </div>
        <table class="table">
            <tr>
            ...
            <tr>
                ...
                <td class="content">
                    ...
                    <asp:RequiredFieldValidator ID="rdfPassword" runat="server" ErrorMessage="글 비밀번호는 필수 입력 항목입니다." ControlToValidate="txtPassword" Display="None"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr><td colspan="2" class="blank"></td></tr>
            <tr>
            ...
            <tr>
                ...
                <td class="content">
                    <asp:TextBox ID="txtMessage" runat="server" Width="1000px" Height="200px" CssClass="textbox" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
        ...
        <div class="buttons">
            <asp:ImageButton ID="btnReply" runat="server" ImageUrl="~/images/btn_reply.gif" onclick="btnReply_Click"/>
