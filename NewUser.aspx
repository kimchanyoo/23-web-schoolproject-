<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="NewUser.aspx.cs" Inherits="NewUser" %>
    ...
    <div class="all-content">
        <table  class="login-content">
            <tr>
                <td colspan="2">
                    <br />
                    <asp:Label ID="Label4" runat="server" Text="회원가입" CssClass="label"></asp:Label>
                    <br /> <br /> <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style">
                    <asp:TextBox ID="txtID" runat="server" CssClass="textbox"  Placeholder=" ID"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style">
            ...
            <tr>
                <td colspan="2">
                    <br /> <br />
                    <asp:Button ID="Button9" runat="server" Text="회원가입" OnClick="Button9_Click" CssClass="button" />
                </td>
            </tr>
        </table>
