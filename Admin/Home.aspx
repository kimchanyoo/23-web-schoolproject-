    ...
    <table class="all-content">
        <tr>
            ...
            <td class="right-content">
                <asp:Label ID="Label4" runat="server">관리자님, 환영합니다.</asp:Label>
                <br /><br /><br />
                <asp:LinkButton ID="LinkButton3" runat="server" CssClass="schedule-btn" PostBackUrl="~/Admin/List_User_A.aspx">회원 리스트 보기</asp:LinkButton>
                &nbsp &nbsp &nbsp
                <asp:LinkButton ID="LinkButton4" runat="server" CssClass="schedule-btn" PostBackUrl="~/Admin/List_Board_A.aspx">게시판 리스트 보기</asp:LinkButton>
                <br /><br /><br />
